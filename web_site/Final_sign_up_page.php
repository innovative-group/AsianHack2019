				...
				<div class= "row"> 
					...
					<div class= "col-md-5"> 
						...
						<div class= "row"> 
							...
							<div class= "col-md-10"> <input type= "text" class= "form-control" name= "username" placeholder= "username" id="username"> </div> 
						...
						<div class= "row"> 
							...
							<div class= "col-md-10"> <input type= "password" class= "form-control" name= "password" placeholder= "password" id="password">  </div> 
						...
						<div class= "row"> 
							...
							<div class= "col-md-10"> 
								...
								<input type= "number" name= "phone" class= "form-control" placeholder= "contact number" id="phone"> </div> 
						...
						<div class= "row"> 
							...
							<div class= "col-md-10"> <input type= "text" class= "form-control" name= "address" placeholder= "home town address" id="address"> </div> 
